...
import { BulkResultDto } from './bulk-result-dto.model';

export interface IBulkResultDtoApiResponse {
    errorMessageCodes?: Array<string>;
    data?: BulkResultDto;
}


export class BulkResultDtoApiResponse extends BaseModel implements IBulkResultDtoApiResponse  {
    errorMessageCodes: Array<string>;
    data: BulkResultDto;
