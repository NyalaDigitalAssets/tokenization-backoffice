...
export interface ICustomerAccountDtoApiResponse {
    errorMessageCodes?: Array<string>;
    data?: CustomerAccountDto;
}


export class CustomerAccountDtoApiResponse extends BaseModel implements ICustomerAccountDtoApiResponse  {
    errorMessageCodes: Array<string>;
    data: CustomerAccountDto;
    ...
    */
    constructor(values?: any, useFormGroupValuesToModel = false) {
        ...
        this.data = new CustomerAccountDto(); 
