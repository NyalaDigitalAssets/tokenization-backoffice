...
import { EtfDto } from './etf-dto.model';

export interface IEtfDtoApiResponse {
    errorMessageCodes?: Array<string>;
    data?: EtfDto;
}


export class EtfDtoApiResponse extends BaseModel implements IEtfDtoApiResponse  {
    errorMessageCodes: Array<string>;
    data: EtfDto;
