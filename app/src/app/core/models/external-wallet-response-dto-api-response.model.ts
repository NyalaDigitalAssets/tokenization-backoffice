...
import { ExternalWalletResponseDto } from './external-wallet-response-dto.model';

export interface IExternalWalletResponseDtoApiResponse {
    errorMessageCodes?: Array<string>;
    data?: ExternalWalletResponseDto;
}


export class ExternalWalletResponseDtoApiResponse extends BaseModel implements IExternalWalletResponseDtoApiResponse  {
    errorMessageCodes: Array<string>;
    data: ExternalWalletResponseDto;
    ...
    */
    constructor(values?: any, useFormGroupValuesToModel = false) {
        ...
        this.data = new ExternalWalletResponseDto(); 
