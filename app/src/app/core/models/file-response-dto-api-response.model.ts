...
import { FileResponseDto } from './file-response-dto.model';

export interface IFileResponseDtoApiResponse {
    errorMessageCodes?: Array<string>;
    data?: FileResponseDto;
}


export class FileResponseDtoApiResponse extends BaseModel implements IFileResponseDtoApiResponse  {
    errorMessageCodes: Array<string>;
    data: FileResponseDto;
