...
import { IssuerWalletRecoveryKitFileDto } from './issuer-wallet-recovery-kit-file-dto.model';

export interface IIssuerWalletRecoveryKitFileDtoApiResponse {
    errorMessageCodes?: Array<string>;
    data?: IssuerWalletRecoveryKitFileDto;
}


export class IssuerWalletRecoveryKitFileDtoApiResponse extends BaseModel implements IIssuerWalletRecoveryKitFileDtoApiResponse  {
    errorMessageCodes: Array<string>;
    data: IssuerWalletRecoveryKitFileDto;
    ...
    */
    constructor(values?: any, useFormGroupValuesToModel = false) {
        ...
        this.data = new IssuerWalletRecoveryKitFileDto(); 
