...
export interface IIssuerWalletSeedDtoApiResponse {
    errorMessageCodes?: Array<string>;
    data?: IssuerWalletSeedDto;
}


export class IssuerWalletSeedDtoApiResponse extends BaseModel implements IIssuerWalletSeedDtoApiResponse  {
    errorMessageCodes: Array<string>;
    data: IssuerWalletSeedDto;
    ...
    */
    constructor(values?: any, useFormGroupValuesToModel = false) {
        ...
        this.data = new IssuerWalletSeedDto(); 
