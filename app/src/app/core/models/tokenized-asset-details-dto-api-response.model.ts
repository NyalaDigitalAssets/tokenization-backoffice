...
import { TokenizedAssetDetailsDto } from './tokenized-asset-details-dto.model';

export interface ITokenizedAssetDetailsDtoApiResponse {
    errorMessageCodes?: Array<string>;
    data?: TokenizedAssetDetailsDto;
}


export class TokenizedAssetDetailsDtoApiResponse extends BaseModel implements ITokenizedAssetDetailsDtoApiResponse  {
    errorMessageCodes: Array<string>;
    data: TokenizedAssetDetailsDto;
    ...
    */
    constructor(values?: any, useFormGroupValuesToModel = false) {
        ...
        this.data = new TokenizedAssetDetailsDto(); 
