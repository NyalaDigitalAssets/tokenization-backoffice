...
export interface ITokenizedAssetDtoApiResponse {
    errorMessageCodes?: Array<string>;
    data?: TokenizedAssetDto;
}


export class TokenizedAssetDtoApiResponse extends BaseModel implements ITokenizedAssetDtoApiResponse  {
    errorMessageCodes: Array<string>;
    data: TokenizedAssetDto;
    ...
    */
    constructor(values?: any, useFormGroupValuesToModel = false) {
        ...
        this.data = new TokenizedAssetDto(); 
