...
import { WalletBasicInfoDto } from './wallet-basic-info-dto.model';

export interface IWalletBasicInfoDtoApiResponse {
    errorMessageCodes?: Array<string>;
    data?: WalletBasicInfoDto;
}


export class WalletBasicInfoDtoApiResponse extends BaseModel implements IWalletBasicInfoDtoApiResponse  {
    errorMessageCodes: Array<string>;
    data: WalletBasicInfoDto;
    ...
    */
    constructor(values?: any, useFormGroupValuesToModel = false) {
        ...
        this.data = new WalletBasicInfoDto(); 
