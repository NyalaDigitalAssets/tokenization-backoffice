...
import { WalletFundingResultsDto } from './wallet-funding-results-dto.model';

export interface IWalletFundingResultsDtoApiResponse {
    errorMessageCodes?: Array<string>;
    data?: WalletFundingResultsDto;
}


export class WalletFundingResultsDtoApiResponse extends BaseModel implements IWalletFundingResultsDtoApiResponse  {
    errorMessageCodes: Array<string>;
    data: WalletFundingResultsDto;
    ...
    */
    constructor(values?: any, useFormGroupValuesToModel = false) {
        ...
        this.data = new WalletFundingResultsDto(); 
