...
import { WealthManagementOverviewDto } from './wealth-management-overview-dto.model';

export interface IWealthManagementOverviewDtoApiResponse {
    errorMessageCodes?: Array<string>;
    data?: WealthManagementOverviewDto;
}


export class WealthManagementOverviewDtoApiResponse extends BaseModel implements IWealthManagementOverviewDtoApiResponse  {
    errorMessageCodes: Array<string>;
    data: WealthManagementOverviewDto;
    ...
    */
    constructor(values?: any, useFormGroupValuesToModel = false) {
        ...
        this.data = new WealthManagementOverviewDto(); 
