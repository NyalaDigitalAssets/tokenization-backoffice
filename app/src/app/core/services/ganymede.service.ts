...
export class CustomApiService {
    ...
    postTokenizedAssetsTransferTokenizedAssets = (issuerwalletseedid: string, issuerwalletid: string, tokenizedassetid: string, data: IssuerWalletTokenizedAssetTransferDto, showLoading: boolean = true, handleErrorGlobally: boolean = true): Observable<GuidListApiResponse> => this.apiService.post<IssuerWalletTokenizedAssetTransferDto, GuidListApiResponse>(`/api/external/v1/issuer-wallet-seeds/${issuerwalletseedid}/issuer-wallets/${issuerwalletid}/tokenzid-assets/${tokenizedassetid}/transfer`, data, showLoading, handleErrorGlobally);
    postTokenizedAssetsLockIssuerWallet = (issuerwalletseedid: string, issuerwalletid: string, data: SimpleAccessCredentialsDto, showLoading: boolean = true, handleErrorGlobally: boolean = true): Observable<BooleanApiResponse> => this.apiService.post<SimpleAccessCredentialsDto, BooleanApiResponse>(`/api/external/v1/issuerWalletSeeds/${issuerwalletseedid}/issuerWallets/${issuerwalletid}/lock`, data, showLoading, handleErrorGlobally);
    postTokenizedAssetsAuthorizeOptIn = (issuerwalletseedid: string, issuerwalletid: string, tokenizedassetid: string, data: ToggleOptInAuthorizationDto, showLoading: boolean = true, handleErrorGlobally: boolean = true): Observable<BooleanApiResponse> => this.apiService.post<ToggleOptInAuthorizationDto, BooleanApiResponse>(`/api/external/v1/issuerWalletSeeds/${issuerwalletseedid}/issuerWallets/${issuerwalletid}/tokenizedAssets/${tokenizedassetid}/authorize-opt-in`, data, showLoading, handleErrorGlobally);
    postTokenizedAssetsRewokeOptIn = (issuerwalletseedid: string, issuerwalletid: string, tokenizedassetid: string, data: ToggleOptInAuthorizationDto, showLoading: boolean = true, handleErrorGlobally: boolean = true): Observable<BooleanApiResponse> => this.apiService.post<ToggleOptInAuthorizationDto, BooleanApiResponse>(`/api/external/v1/issuerWalletSeeds/${issuerwalletseedid}/issuerWallets/${issuerwalletid}/tokenizedAssets/${tokenizedassetid}/rewoke-opt-in`, data, showLoading, handleErrorGlobally);
