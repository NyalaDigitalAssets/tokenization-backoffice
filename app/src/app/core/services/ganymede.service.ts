...
export class CustomApiService {
    ...
    postTokenizedAssetsBuildAndSubmitMetadaFile = (issuerwalletseedid: string, issuerwalletid: string, tokenizedassetid: string, data: CreateMetadataFileDto, showLoading: boolean = true, handleErrorGlobally: boolean = true): Observable<BooleanApiResponse> => this.apiService.post<CreateMetadataFileDto, BooleanApiResponse>(`/api/external/v1/issuer-wallet-seeds/${issuerwalletseedid}/issuer-wallets/${issuerwalletid}/tokenized-assets/${tokenizedassetid}/metadata`, data, showLoading, handleErrorGlobally);
