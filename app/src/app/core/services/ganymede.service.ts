...
export class CustomApiService {
    ...
    postTokenizedAssetsRewokeOptIn = (issuerwalletseedid: string, issuerwalletid: string, tokenizedassetid: string, data: ToggleOptInAuthorizationDto, showLoading: boolean = true, handleErrorGlobally: boolean = true): Observable<BooleanApiResponse> => this.apiService.post<ToggleOptInAuthorizationDto, BooleanApiResponse>(`/api/external/v1/issuer-wallet-seeds/${issuerwalletseedid}/issuer-wallets/${issuerwalletid}/tokenized-assets/${tokenizedassetid}/rewoke-opt-in`, data, showLoading, handleErrorGlobally);
